...
# GRIB variable name varies by provider/engine. We keep a preferred name here,
# but processors will fall back to common alternatives (e.g. "2t").
DEFAULT_INPUT_VAR = "t2m"

# Operational output variable (NetCDF) must be one of these.
TEMP_ALLOWED = {
    "2m_air_temperature",
...
class HindcastConfig:
    ...
    # Output variable name used in processed hindcast NetCDF (operational convention)
    out_var_name: str = "2m_air_temperature"
